...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/install/ultrasonic_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ultrasonic_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ultrasonic_control/environment/path.sh"
